...
<!--INICIO del cont principal-->
<br>
<form method="POST" action="ahorro_pagos.php">
    <?php 
  ...
  <tbody>
    ...
    // Conexión a la base de datos
       ...
       $id = $fila['id'];
        ...
        $sql2 = "SELECT fecha,abono FROM couta_ahorro WHERE asesor = '$asesor'";
...
<?php 
    ...
    $sql3 = "SELECT SUM(abono) as abono FROM couta_ahorro WHERE asesor = '$asesor'";
    ...
    $sql3 = "SELECT * FROM `ahorro` WHERE asesor = '$asesor'";
    $resultado4 = $conexion->query($sql3);
