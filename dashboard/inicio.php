                                ...
                                <div class="panel h-full">
                                    <div class="-m-5 mb-5 flex items-start border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                                        <div class="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                                            <img src="assets/images/profile-1.jpeg" alt="image" class="h-10 w-10 rounded-full object-cover">
                                        </div>
                                ...
                                <div class="panel h-full">
                                    <div class="-m-5 mb-5 flex items-center justify-between border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                                        <div class="flex">
                                            <div class="media-aside align-self-start">
                                                <div class="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                                                    <img src="assets/images/g-8.png" alt="image" class="h-10 w-10 rounded-full object-cover">
                                                </div>
                                            </div>
                                            <div class="font-semibold">
                                    ...
                                    <div class="pb-8 text-center font-semibold">
                                        ...
                                        <div class="flex items-center justify-center gap-3 pb-8">
                                            <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="assets/images/profile-1.jpeg" alt="image">
                                            <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="assets/images/profile-2.jpeg" alt="image">
                                            <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="assets/images/profile-3.jpeg" alt="image">
                                            <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="assets/images/profile-4.jpeg" alt="image">
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="flex items-end justify-between">
                                            ...
                                            <div class="flex items-center justify-center group-hover:-space-x-2 rtl:space-x-reverse rtl:group-hover:space-x-reverse">
                                                ...
                                                <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="assets/images/profile-6.jpeg" alt="image">
                                                <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="assets/images/profile-7.jpeg" alt="image">
                                                <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="assets/images/profile-8.jpeg" alt="image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
