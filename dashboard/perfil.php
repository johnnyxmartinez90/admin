...
/*foreach ($data as $row) {
    // Accede a las columnas por su nombre (o índice) y imprímelas
    echo 'ID: ' . $row['id'] . '<br>';
                                ...
                                <div class="panel">
                                    ...
                                    ?>
                                        <div class="flex flex-col items-center justify-center">
                                            <img src="data:image/jpeg;base64,<?php echo base64_encode($row['contenido']); ?>" alt="image" class="mb-5 h-24 w-24 rounded-full object-cover">
                                            <?php foreach ($data as $row) { 
                            
                                        ?>
                                            <p class="text-xl font-semibold text-primary"><?php echo $row['nombres'] ;?></p>
                                        </div>
                                        <ul class="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                                            ...
                                            <li>
                                                <a href="javascript:;" class="flex items-center gap-2">
                                                    ...
                                                    <span class="whitespace-nowrap" dir="ltr"><?php echo $row['correo'] ;?></span>
                                            </li>
                                            <li class="flex items-center gap-2">
                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                                ...
                                                <span class="whitespace-nowrap" dir="ltr"><?php echo $row['telefono'] ;?></span>
                                            </li>
                                        </ul>
                                        <?php } ?>
